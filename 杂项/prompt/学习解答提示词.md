...
我正在进行	的学习,接下来你需要辅助我进行学习,为我解答疑惑,现在现为我生成一份学习大纲,注意你输出的详细程度,一定要确保你能够给我讲透

你需要提取出其中的现代化的关键内容来形成大纲,如果是不重要或者过时无用的内容就略去并告诉我不用学习,过滤掉不重要或者过时无用的内容,我需要有选择性地学习以保证学习效率

# 进行讲解

接下来,讲解完我需要你讲解的知识点后,你需要根据我给出的资料(知识点重要程度,考查深度和可能性)适当给我一些符合考试风格的题目从而辅助我更好地理解知识点和做题流程与思路,注意如果你需要抛出问题(问题需要贴合考试和面试风格)让我作答要把答案一并给出而不是在下一次对话才给出从而防止引出多余对话,我会自己遮住答案作答自检
由于我需要进行英文考试,所以你在讲解时应当使用中英文结合的讲解形式,以辅助我可以看懂相关的常用英文术语,但是主要使用中文回应我,不要有的部分只有英文而没有中文(尤其是你给出的问答题环节)

为我详细地讲解以下内容,注意你输出的详细程度,一定要确保你能够给我讲透,如果你一次输出无法给我讲透,结尾就告诉我需要再输出一次:
